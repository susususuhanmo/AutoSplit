...
//
//import com.zstu.libdata.KafkaDataClean.ParseCleanUtil
...
//    if (isUseful(jsonMap, "creator")) creator = cnkiOps.getFirstCreator(cnkiOps.cleanAuthor(jsonMap("creator").toString))
//    if (isUseful(jsonMap, "creator_all")) creatorAlt = cnkiOps.cleanAuthor(jsonMap("creator_all").toString)
//    if (isUseful(jsonMap, "creator")) creatorAll = cnkiOps.cleanAuthor(jsonMap("creator").toString)
//    if(creatorAll == null || creatorAll.equals("")){
//      creatorAll = creator
//    }
//    if (isUseful(jsonMap, "keyword")) keyWord = cnkiOps.cleanKeyWord(jsonMap("keyword").toString)
//    if (isUseful(jsonMap, "keyword_alt")) keyWordAlt = cnkiOps.cleanKeyWord(jsonMap("keyword_alt").toString)
//    if (isUseful(jsonMap, "institute_2")) instituteAll = cnkiOps.cleanInstitute(jsonMap("institute_2").toString)
//    if (isUseful(jsonMap, "year")) year = jsonMap("year").toString
//    if (isUseful(jsonMap, "journal_2")) journal = cnkiOps.cleanUnJournal(jsonMap("journal_2").toString)
//    if (isUseful(jsonMap, "institute_2")) institute = cnkiOps.getFirstInstitute(cnkiOps.cleanInstitute(jsonMap("institute_2").toString))
...
//    if (isUseful(jsonMap, "creator")) creator = cnkiOps.getFirstCreator(cnkiOps.cleanAuthor(jsonMap("creator").toString))
//    if (isUseful(jsonMap, "title")) title = cnkiOps.cleanTitle(jsonMap("title").toString)
//    if (isUseful(jsonMap, "journal_name")) journal = cnkiOps.cleanJournal(jsonMap("journal_name").toString)
//    if (isUseful(jsonMap, "journal_alt")) journal2 = cnkiOps.cleanJournal(jsonMap("journal_alt").toString)
//    if (isUseful(jsonMap, "year")) year =jsonMap("year").toString
//    if (journal == null || journal.equals("") ) {
//      journal = journal2
//    }
//    if (isUseful(jsonMap, "institute")) institute = cnkiOps.getFirstInstitute(cnkiOps.cleanInstitute(jsonMap("institute").toString))
//    val key = cutStrOps(title, 6) + cutStrOps(journal, 4)
//    (key, (title, journal, creator, id, institute,year))
//  }
//
...
//    if (isUseful(jsonMap, "keyword_alt")) keyWordAlt = cnkiOps.cleanKeyWord(jsonMap("keyword_alt").toString)
//    if (isUseful(jsonMap, "year")) year = jsonMap("year").toString
//    if (isUseful(jsonMap, "journal_name")) journal = cnkiOps.cleanUnJournal(jsonMap("journal_name").toString)
//    if (isUseful(jsonMap, "journal_alt")) journal2 = cnkiOps.cleanJournal(jsonMap("journal_alt").toString)
//    if (journal == null || journal.equals("") ) {
//      journal = journal2
//    }
//    if (isUseful(jsonMap, "institute")) institute = cnkiOps.getFirstInstitute(cnkiOps.cleanInstitute(jsonMap("institute").toString))
//    if (isUseful(jsonMap, "institute")) instituteAll = cnkiOps.cleanInstitute(jsonMap("institute").toString)
//    if (isUseful(jsonMap, "issue")) issue = jsonMap("issue").toString
//    if (isUseful(jsonMap, "url")) url = jsonMap("url").toString
//    if (isUseful(jsonMap, "abstract")) abstractcont = jsonMap("abstract").toString
//    if (isUseful(jsonMap, "abstract_alt")) abstractcont_alt = jsonMap("abstract_alt").toString
...
//    if (isUseful(jsonMap, "creator")) creator = cnkiOps.getFirstCreator(cnkiOps.cleanAuthor(jsonMap("creator").toString))
//    if (isUseful(jsonMap, "title")) title = cnkiOps.cleanTitle(jsonMap("title").toString)
//    if (isUseful(jsonMap, "journal")) journal = cnkiOps.cleanJournal(jsonMap("journal").toString)
//    if (isUseful(jsonMap, "journal2")) journal2 = cnkiOps.cleanJournal(jsonMap("journal2").toString)
//    if (isUseful(jsonMap, "year")) year =jsonMap("year").toString
//    if (journal == null || journal.equals("")) {
//      journal = journal2
//    }
...
//    if (isUseful(jsonMap, "creator")) creatorAll = cnkiOps.cleanAuthor(jsonMap("creator").toString)
//    if (isUseful(jsonMap, "keyword")) keyWord = cnkiOps.cleanKeyWord(jsonMap("keyword").toString)
//    if (isUseful(jsonMap, "instituteAll")) instituteAll = cnkiOps.cleanInstitute(jsonMap("institute").toString)
//    if (isUseful(jsonMap, "year")) year = jsonMap("year").toString
//    if (isUseful(jsonMap, "journal")) journal = cnkiOps.cleanJournal(jsonMap("journal").toString)
//    if (isUseful(jsonMap, "institute")) institute = cnkiOps.getFirstInstitute(cnkiOps.cleanInstitute(jsonMap("institute").toString))
//    if (isUseful(jsonMap, "issue")) issue = jsonMap("issue").toString
